...
/**
 * Class representing a "generic weather". All of the weather effects in the
 * game consist of generating - updating - rendering and use the same variables,
 * but different configurations.
 *
 * This class work like some kinf of factory. The user don't have to import the
 * specific classes, the Weather is perfectly enough.
 *
 * @author Jeremi
 */
public abstract class Weather {
    ...
    /**
     * Generates the particles of the weather effects in the given amount
     * (amount variable).
     */
    public abstract void generate();

    /**
     * Updates the weather particles, by supposedly moving them. The delta is
    ...
    /**
     * Render a static weather effects which rotates when the player turns
     * around.
     *
     * @param g
     * @param offscreenX
