...
/**
 * Helper class for image and graphic manipulation such as scaling, fog
 * effect..etc.
 *
 * @author Jeremi
 */
public final class ImageAndPostProcessHelper {
    ...
    /////////////////////////////// IMAGE MAINPULATION ///////////////////////////////////////
    /**
     * Nearest-neighbor-image-scaling function. Source:
     ...
     *
     * @see ImageAndPostProcessHelper#scaleNearest(java.awt.image.BufferedImage,
     * double)
     * @param before
     * @param w2
     * @param h2
     ...
     *
     * @see ImageAndPostProcessHelper#scale(java.awt.image.BufferedImage,
     * double, int)
     * @param before
     * @param scale
     * @param type
